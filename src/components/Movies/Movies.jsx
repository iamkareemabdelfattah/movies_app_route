  ...
  return (
    <>
      ...
      { trendingMovies != null ? <div className="container">
        ...
        <input type="text" onKeyUp={ searchMovie } className="form-control bg-transparent text-white my-5" placeholder="Search ...." />

        <div className="row mt-5 align-items-center">



          { trendingMovies.map( ( movie, idx ) => <div key={ idx } className="col-md-2">

            <div className="movie">

              <Link to={ `/details/${ movie.id }` }>
              
              <img src={ "https://image.tmdb.org/t/p/w500/" + movie.profile_path } className="w-100" alt={ movie.title } />
              <h6> { movie.name } </h6>
              </Link>
            </div>
